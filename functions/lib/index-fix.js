...
async function uploadToVectorSearchV3(records, projectId, location, indexId) {
    try {
        ...
        for (let i = 0; i < maxBatches; i++) {
            ...
            try {
                ...
                // REST APIリクエスト
                const response = await axios_1.default.post(apiEndpoint, { datapoints: batch }, {
                    headers: {
...
//# sourceMappingURL=index-fix.js.map