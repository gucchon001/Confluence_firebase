...
async function main() {
    try {
        ...
        console.log(`[main] Request body (truncated):`, JSON.stringify(Object.assign(Object.assign({}, requestBody), { datapoints: [Object.assign(Object.assign({}, testDatapoint), { featureVector: [...testDatapoint.featureVector.slice(0, 5), '...'] })] }), null, 2));
        // APIリクエストを送信
...
// スクリプト実行
main();
//# sourceMappingURL=test-vector-search-upsert.js.map