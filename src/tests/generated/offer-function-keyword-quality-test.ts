/**
 * offer-function キーワード抽出品質テスト
 * 自動生成されたテストケース
 */

async function testOfferFunctionKeywordExtraction() {
  console.log('🚀 offer-function キーワード抽出品質テスト開始');
  console.log('=' .repeat(60));

  const query = 'オファー機能の詳細を教えて';
  ...
  console.log('');
  console.log('=' .repeat(60));
  console.log('✅ offer-function キーワード抽出品質テスト完了');
}
...
// テスト実行
testOfferFunctionKeywordExtraction();
