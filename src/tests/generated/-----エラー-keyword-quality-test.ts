...
async function testエラーKeywordExtraction() {
  console.log('🚀 -----エラー キーワード抽出品質テスト開始');
  console.log('=' .repeat(60));

  const query = '応募管理でエラーのは何が原因ですか';
  ...
  console.log('');
  console.log('=' .repeat(60));
  console.log('✅ -----エラー キーワード抽出品質テスト完了');
}
