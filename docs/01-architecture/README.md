...
4. [Phase 0A機能](#4-phase-0a機能)
   - 4.1 [Structured Label](#41-structured-label) (4.1.1-4.1.3)
   - 4.2 [Knowledge Graph](#42-knowledge-graph)
   - 4.3 [ドメイン知識](#43-ドメイン知識) (4.2.1)
5. [パフォーマンス最適化](#5-パフォーマンス最適化)
   - 5.1 [LunrキャッシュGCS統合](#51-lunrキャッシュgcs統合) (5.1.1)
...
| 4.1.3 | [04.01.03-structured-label-status-and-improvements.md](./04.01.03-structured-label-status-and-improvements.md) | **実装状況と改善ガイド**<br>実装状況、現状分析、生成精度向上の方法 | 2025-01-27 |
...
- 複数インスタンス間でキャッシュを共有
- 自動保存・読み込み機能により、手動操作不要

**主要機能**:
- 起動時: ローカルキャッシュがない場合、GCSから自動ダウンロード
- 保存時: ローカル保存後、GCSにも自動アップロード
- 環境判定: 本番環境（Cloud Run）でのみ有効化
...
| # | ドキュメント | 説明 | 最終更新 |
|---|------------|------|---------|
| 6.1 | [05.01.01-ui-ux-performance-strategy.md](./05.01.01-ui-ux-performance-strategy.md) | UI/UXパフォーマンス戦略<br>ストリーミングUI、レスポンシブ設計 | 2025-01 |
...
| # | ドキュメント | 説明 | 最終更新 |
|---|------------|------|---------|
| 8.1.1 | [08.01.01-performance-analysis-2025-11.md](./08.01.01-performance-analysis-2025-11.md) | **パフォーマンス分析レポート**<br>本番環境・開発環境のパフォーマンス分析、問題点、改善策 | 2025-11-21 |
...
**場所**: `docs/99-archive/architecture/completed-reports/`
...
**場所**: `docs/99-archive/architecture/deprecated/`
...
**場所**: `docs/99-archive/architecture-legacy/`

### 7.4 2025年11月に統合・アーカイブしたファイル

**パフォーマンス分析関連** (2025-11-21):
- **場所**: `docs/99-archive/architecture/performance-analysis-2025-11/`
- **統合先**: `08.01.01-performance-analysis-2025-11.md`
- 9ファイルを統合
...
- **統合先**: `04.01.03-structured-label-status-and-improvements.md`
- 3ファイルを統合
